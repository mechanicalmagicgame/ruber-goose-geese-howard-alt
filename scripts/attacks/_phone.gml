...
set_window_value(AT_PHONE, 1, AG_WINDOW_ANIM_FRAMES, 4);
...
set_window_value(AT_PHONE, 2, AG_WINDOW_ANIM_FRAME_START, 4);

//Closing window

set_window_value(AT_PHONE, 3, AG_WINDOW_LENGTH, 12);
set_window_value(AT_PHONE, 3, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_PHONE, 3, AG_WINDOW_ANIM_FRAME_START, 5);