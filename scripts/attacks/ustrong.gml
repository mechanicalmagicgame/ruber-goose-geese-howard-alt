...
set_hitbox_value(AT_USTRONG, 2, HG_ANGLE, 30);
set_hitbox_value(AT_USTRONG, 2, HG_ANGLE_FLIPPER, 5);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_X, -34);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -54);
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 40);
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 108);
